program main
    ...
    real(kind=8)::kf_b,t,up_k,down_k
...
!            alpha_n=cal_alpha(rho_b)
	       ...
	       ! write(3,100)rho_b/rho0,g_ome_kaon,g_sig_kaon,rho_kaon,che_e,che_kaon,&
           !     (M_meson_kaon-g_sig_kaon*sigma)/M_meson_kaon,sigma,effect_nucl/Mb,g_sigma*sigma/Mb
            write(3,100)rho_b/rho0,g_sig_kaon,g_sig_lam/g_sigma,g_sig_sig/g_sigma,g_sig_ksi/g_sigma
	    ...
	    if(par=='n'.or.par=='N') then
            ...
            rho_delta2/rho_b,rho_delta1/rho_b,rho_delta0/rho_b,rho_delta_1/rho_b,rho_kaon/rho_b
	        write(2,'(3e15.6)')rho_b,Pressure(num),Energy(num)
!	        write(3,100)rho_b/rho0,g_sig_kaon/g_sigma,g_sig_delta/g_sigma,g_sigma,sigma,effect_nucl/Mb,g_sigma*sigma/Mb
            write(3,100)rho_b/rho0,g_sig_kaon/g_sigma,X_sig_lam,X_sig_sig,X_sig_ksi
            write(4,*)rho_b,Energy(num)*1.7827e12,M_neutron,R_neutron
	        end do
        end if
            write(*,*) "done!"
