...
rho=np.arange(1.6e13,3.5e15,0.5e12)
rho=np.append(rho,np.arange(6.4e13,1.4e16,0.5e13))
...
plt.plot(M_s,k2_s,'r--',label="DDME1 EoS")
...
ax.set_ylabel(r"Love Number [$k_2$]")
plt.plot(C_s,k2_s,'r--',label="DDME1 EoS")
...
ax.set_xlabel(r"Mass of the Star [$M_\odot$]")
ax.set_ylabel(r"Tidal Deformability")
ax.set_ylim(1,1000)
ax.set_yscale('log')
plt.plot(M_s,L_s,'r--',label="DDME1 EoS")
