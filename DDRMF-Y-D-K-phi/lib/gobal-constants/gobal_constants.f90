...
!particle density-----------------------------------------------------
         ...
         real(kind=8)::rho_e
         real(kind=8)::rho_u
         real(kind=8)::rho_delta2
         real(kind=8)::rho_delta1
         real(kind=8)::rho_delta0
         real(kind=8)::rho_delta_1
!kaon meson
         real(kind=8)::rho_kaon
         real(kind=8)::che_kaon
!fermi energy------------------------------------------------------------
         ...
         real(kind=8),save::kf_delta2
         real(kind=8),save::kf_delta1
         real(kind=8),save::kf_delta0
         real(kind=8),save::kf_delta_1
...
!chemical potentials and chemical min------------------------------------
	     ...
	     real(kind=8),save::che_delta2
         real(kind=8),save::che_delta1
         real(kind=8),save::che_delta0
         real(kind=8),save::che_delta_1
         ...
         real(kind=8),save::che_delta2_min
         real(kind=8),save::che_delta1_min
         real(kind=8),save::che_delta0_min
         real(kind=8),save::che_delta_1_min
...
!isopin 3rd--------------------------------------------------- 
         ...
         real(kind=8),parameter::iso_delta2= 1.5
         real(kind=8),parameter::iso_delta1= 0.5
         real(kind=8),parameter::iso_delta0= - 0.5
         real(kind=8),parameter::iso_delta_1= - 1.5
...
!other constants--------------------------------------------------		 
         ...
         real(kind=8),public,save::Energy(3000),Pressure(3000),Pressure1(3000)
